...
namespace WaveEchoRGB
{
    public class PressedKey
    {
        ...
        public KeyboardNames Name { get; set; }

        public PressedKey(int name)
            : this((KeyboardNames)name) { }
                        ...
                        // edit just this file to adapt the application to any other keyboard layout.
    {
        ...
        public static readonly Dictionary<int, int> WinToHid = new Dictionary<int, int>
        {
            [1] = 1,
            [2] = 2,
            [3] = 3,
        ...
        private readonly static int[,] keyLocations = new int[,] {
            ...
            {0x33,186,502,row4},//;
            {0x34,222,542,row4},//'
            {0x32,220,582,row4},//     European extra key \
            ...
            {0x5A,98,854,row5},//2
            {0x5B,99,893,row5},//3
            {0x58,176,933,245},//kp_enter   Windows sends 13 for both enter keys but included here for lighting
            //{0xB0,176,933,245},
            ...
            {0xE7,92,517,row6},//Rwin // FN function
        ...
        private readonly static int keysCount = keyLocations.Length / 4;  // div 4 because .Length counts elements in all dimensions.
